...
FLAG_PREFIX = "GUAM/PrecipFlag_00.00"
...
SINGLE_PRODUCTS = {
    ...
    'qpe6h': {
        'prefix': 'GUAM/RadarOnly_QPE_06H_00.00',
    ...
    'qpe24h': {
        'prefix': 'GUAM/RadarOnly_QPE_24H_00.00',
    ...
    'refl': {
        'prefix': 'GUAM/MergedBaseReflectivityQC_00.50',
    ...
    'lightning': {
        'prefix': 'GUAM/LightningProbabilityNext60minGrid_scale_1',
    ...
    'rotation': {
        'prefix': 'GUAM/MergedAzShear_0-2kmAGL_00.50',
...
def _fetch_hrrr_vars_s3(date_str, hour_str, hours_back):
    ...
    base_url = (
        f"{HRRR_BUCKET}/hrrr.{date_str}/GUAM"
...
def discover_rate_prefix():
    ...
    url = f"{BUCKET_URL}/?list-type=2&prefix=GUAM/&delimiter=/"
    try:
        ...
        pass
    return "GUAM/SurfacePrecipRate_00.00"
